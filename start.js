...
// CONFIG
// ===========================================================================
// console.log(webpackConfig.plugins[4].options.options);
const PATHS = webpackConfig.plugins[4].options.options.PATHS;
const PROXY_TARGET = webpackConfig.plugins[4].options.options.PROXY_TARGET;
const bsOptions = {
  port: 3000,
